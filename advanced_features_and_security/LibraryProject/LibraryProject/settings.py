...
# Custom User Model (CRITICAL - add this line after INSTALLED_APPS)
AUTH_USER_MODEL = 'relationship_app.CustomUser'  # Since your models are in relationship_app

# Media files configuration (add after STATIC_URL)
MEDIA_URL = '/media/'
